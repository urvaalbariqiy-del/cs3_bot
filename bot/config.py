...
# Saytdagi sessiya amal qilish muddati.
# DOIMIY: foydalanuvchi o'zi "Chiqish" bosmagunча tizimda qoladi (10 yil).
# Har tashrifda token yangilanadi (/api/me), shuning uchun amalda cheksiz.
TOKEN_TTL_SECONDS = int(os.getenv("TOKEN_TTL_SECONDS", str(3650 * 24 * 3600)))

# Admin ham xuddi shunday — doimiy (10 yil).
ADMIN_TOKEN_TTL_SECONDS = int(os.getenv("ADMIN_TOKEN_TTL_SECONDS", str(3650 * 24 * 3600)))
